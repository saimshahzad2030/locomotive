...
const About = () => {
  ...
  return (
    <div
      className="flex flex-col items-center w-full mt-[100px]"
      // style={{
      //   backgroundColor: currentBg.bg, // Set the dynamic background color
      // }}
    >
      <div className="container mx-auto w-full">
        <div className="min-h-screen-minus-100 flex flex-col items-center justify-center w-full mt-2 relative">
                ...
                <div
                  ...
                  className={`${
                    ...
                    activeSlideIndex !== index
                      ? `${styles["inactive-slide"]} h-[200px] mt-[100px]`
                      : "h-[400px]"
                  }`}
                  style={{
                    transform: `rotateY(${
